...
export async function saveMeal(meal) {
  ...
  if (await getMeal(meal.slug)) {
    // returning promise here because this function was already returing promise<void>
    return Promise.resolve({
      field: 'title',
      message: 'Title already exist, Please try with new Title.'
    });
  }
